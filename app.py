...
with st.sidebar:
    ...
    <div style='text-align:center; padding: 10px 0 20px 0;'>
        ...
        <div style='font-size: 15px; font-weight: 700; line-height: 1.3;'>IVF Tâm Anh HN</div>
        <div style='font-size: 11px; opacity: 0.8; margin-top: 3px;'>Quality Audit System</div>
    </div>
    """, unsafe_allow_html=True)
