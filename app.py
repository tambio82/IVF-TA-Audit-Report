...
"""
# NOTE: "No module named 'utils'" được fix bằng .streamlit/config.toml
# với cấu hình: pythonpath = ["."]
# Không cần sys.path hack ở đây.
...
# ── ALL imports early, before any st.markdown calls ────────────────────────────
...
.main-header p  { margin: 0; font-size: 13px; opacity: 0.85; }
...
.stForm { background: #f8f9fa; border-radius: 10px; padding: 10px; }
</style>
...
<div class="main-header">
    ...
    <div style='text-align:right; font-size:13px; opacity:0.9;'>{selected_page}</div>
</div>
""", unsafe_allow_html=True)
...
elif page_key == "module3": module3_dashboard.render()
elif page_key == "module4": module4_export.render()
elif page_key == "module5": module5_users.render()
elif page_key == "module6": module6_options.render()
